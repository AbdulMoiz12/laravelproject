...
<div class="header navbar navbar-inverse"> 
    ...
    <div class="navbar-inner">
        ...
        <div class="header-seperation"> 
            ...
            <!-- END MOBILE HEADER -->
            <!-- BEGIN LOGO --> 
            <h4><strong style="color:white">Mera Sms <br>CMS Panel</strong></h4>
            <!-- END LOGO --> 
            </div>
                ...
                <div class="chat-toggler">  
                    ...
                    <a href="#">
                        <div class="user-details"> 
                            <div class="username">
                                <span class="bold"> Abdul Moiz</span>                                   
                            </div>                      
                        </div> 
                        &nbsp; &nbsp; &nbsp; &nbsp; 
                    </a>    
                    ...
                    <div class="profile-pic"> 
                        <img src="/_assets/img/profiles/h2x.jpg" alt="" data-src="/_assets/img/profiles/h2x.jpg" data-src-retina="/_assets/img/profiles/h2x.jpg" width="35" height="35" /> 
                    </div>  
                    <!-- END PROFILE PICTURE -->                
                </div>
    ...
    <div class="page-sidebar" id="main-menu"> 
        ...
        <div class="user-info-wrapper"> 
            <div class="profile-wrapper">
                <img src="/_assets/img/profiles/h2x.jpg" alt="" data-src="/_assets/img/profiles/h2x.jpg" data-src-retina="/_assets/img/profiles/h2x.jpg" width="69" height="69" />
            </div>
            <div class="user-info">
                <div class="greeting">Welcome</div>
                <div class="username"><span class="semi-bold"> Abdul Moiz</span></div> &nbsp; &nbsp;
            </div>
        </div>
        <!-- END MINI-PROFILE -->
        <!-- BEGIN SIDEBAR MENU --> 
        ...
        <ul>
            <li class="start active"><a href="{{ route('admin..category.index') }}"><i class="fa fa-tasks"></i><span class="title">Category</span><span class="selected"></span></a></li>
            <li class="start active"><a href="{{ route('admin..sms.index') }}"><i class="fa fa-briefcase"></i><span class="title">Sms</span><span class="selected"></span></a></li>
